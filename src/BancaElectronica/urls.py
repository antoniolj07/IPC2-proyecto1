...
from home.views import home_view, about_view, nueva_cuenta_view, estado_cuenta_view, cuentas_propias_view, transferencia_terceros_view, pagos_view, prestamo_view
